<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="UnallocateReport.aspx.cs" Inherits="JMReports.WebApp.Unallocate.UnallocateReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="Unallocate\UnallocateRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="UnallocateReportDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
