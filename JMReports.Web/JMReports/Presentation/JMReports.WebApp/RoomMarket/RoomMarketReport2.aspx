<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RoomMarketReport2.aspx.cs" Inherits="JMReports.WebApp.RoomMarket.RoomMarketReport2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <%--<LocalReport ReportPath="RoomMarket\RoomMarketReport2.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoomMarketReport2" />
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource2" Name="CompanyPriceDS" />
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="GroupDetailDS" />
                </DataSources>
            </LocalReport>--%>
        </rsweb:ReportViewer>
