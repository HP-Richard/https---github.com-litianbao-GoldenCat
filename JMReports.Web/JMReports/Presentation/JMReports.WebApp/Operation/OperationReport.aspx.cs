...
namespace JMReports.WebApp.Operation
{
    public partial class OperationReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ods.TypeName = " JMReports.WebApp.ReportBussiness.OperationReport";
            ...
            {
                string title = string.Format("{0}{1} {2} 经营情况一览", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
