<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="HotelWholeReport.aspx.cs" Inherits="JMReports.WebApp.HotelWhole.HotelWholeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="HotelWhole\HotelWholeRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="HotelWholeDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
