...
namespace JMReports.WebApp.BanquetMarket
{
    public partial class BanquetMarketReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ods.TypeName = " JMReports.WebApp.ReportBussiness.BanquetMarketReport";
            ...
            {
                string title = string.Format("{0}{1} {2} 宴会细分市场", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
