...
{
    public partial class frmRestaurantMain : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ObjectDataSource ods = this.ObjectDataSource1;
            {
                ...
                ods.SelectMethod = "GetRestaurantMainReport";
            ...
            ReportViewer rv = this.ReportViewer1;
            {
                ...
                string title = string.Format("{0}{1} {2} 主要餐厅报表", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
