<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="frmRestaurantMain.aspx.cs" Inherits="JMReports.WebApp.Restaurant.frmRestaurantMain" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="Restaurant\RestaurantMainReport.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RestaurantReportDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
