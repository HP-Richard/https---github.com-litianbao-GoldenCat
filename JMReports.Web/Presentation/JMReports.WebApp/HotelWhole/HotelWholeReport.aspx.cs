...
namespace JMReports.WebApp.HotelWhole
{
  public partial class HotelWholeReport : System.Web.UI.Page
  {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      {
        ods.TypeName = " JMReports.WebApp.ReportBussiness.HotelWholeReport";
      ...
      {
        string title = string.Format("{0}{1} {2} 酒店整体报表", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
