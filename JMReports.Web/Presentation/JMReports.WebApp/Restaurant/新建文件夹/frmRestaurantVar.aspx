<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="frmRestaurantVar.aspx.cs" Inherits="JMReports.WebApp.Restaurant.frmRestaurantVar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="588px" 
            ...
            <LocalReport ReportPath="Restaurant\RestaurantVarReport.rdlc">
                <DataSources>
