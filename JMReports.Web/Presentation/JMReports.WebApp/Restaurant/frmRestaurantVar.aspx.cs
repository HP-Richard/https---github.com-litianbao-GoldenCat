...
namespace JMReports.WebApp.Restaurant
{
  public partial class frmRestaurantVar : System.Web.UI.Page
  {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      {
        string title = string.Format("{0}{1} {2} 各餐厅报表", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
        string hotel = this.selDept.SelectedValue;
        List<ReportParameter> parameterList = new List<ReportParameter>();
        parameterList.Add(new ReportParameter("title", title));
        parameterList.Add(new ReportParameter("hotel", hotel));
        rv.LocalReport.SetParameters(parameterList);
        //ReportParameter p1 = new ReportParameter("title", title);
        //ReportParameter p2 = new ReportParameter("hotel", hotel);
        //rv.LocalReport.SetParameters(new ReportParameter[] { p1 });
        //rv.LocalReport.SetParameters(new ReportParameter[] { p2 });
