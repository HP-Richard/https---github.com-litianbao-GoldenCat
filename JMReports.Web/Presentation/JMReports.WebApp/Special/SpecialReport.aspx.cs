...
namespace JMReports.WebApp.Special
{
  public partial class SpecialReport : System.Web.UI.Page
  {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      {
        ods.TypeName = " JMReports.WebApp.ReportBussiness.SpecialReport";
      ...
      {
        string title = string.Format("{0}{1} {2} 酒店专用表", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
