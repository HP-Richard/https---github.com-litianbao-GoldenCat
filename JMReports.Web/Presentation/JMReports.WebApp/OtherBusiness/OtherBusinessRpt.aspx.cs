...
namespace JMReports.WebApp.OtherBusiness
{
  public partial class OtherBusinessRpt : System.Web.UI.Page
  {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      {
        ods.TypeName = " JMReports.WebApp.ReportBussiness.OtherBusinessReport";
      ...
      {
        string title = string.Format("{0}{1} {2} 其他运营部门报表", this.ddlYear.SelectedItem.Text, this.ddlMonth.SelectedItem.Text, this.selDept.SelectedItem.Text);
