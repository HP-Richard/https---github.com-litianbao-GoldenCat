<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="OtherBusinessRpt.aspx.cs" Inherits="JMReports.WebApp.OtherBusiness.OtherBusinessRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="588px" 
            ...
            <LocalReport ReportPath="OtherBusiness\OtherBusinessReport.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="OtherBusinessDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
