<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="BanquetMarketReport.aspx.cs" Inherits="JMReports.WebApp.BanquetMarket.BanquetMarketReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="BanquetMarket\BanquetMarket.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="BanquetMarketDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
