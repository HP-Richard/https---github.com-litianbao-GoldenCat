<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="frmRestaurantEfficiency.aspx.cs" Inherits="JMReports.WebApp.Restaurant.frmRestaurantEfficiency" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="Restaurant\RestaurantEfficiency.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RestaurantEfficiencyDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
