<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RoomSalesReport.aspx.cs" Inherits="JMReports.WebApp.RoomSales.RoomSalesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="RoomSales\RoomSales.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoomSalesDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
