<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RoomMarketReport.aspx.cs" Inherits="JMReports.WebApp.RoomMarket.RoomMarketReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="RoomMarket\RoomMarketReport.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoomMarket" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
