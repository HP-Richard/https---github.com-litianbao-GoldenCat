<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="RoomEfficiencyReport.aspx.cs" Inherits="JMReports.WebApp.RoomEfficiency.RoomEfficiencyReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" 
            ...
            <LocalReport ReportPath="RoomEfficiency\RoomEfficiencyRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoomEfficiencyDS" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
